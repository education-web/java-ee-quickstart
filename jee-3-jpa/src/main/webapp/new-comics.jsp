...
<div class="container">
    <form method="post" action="${pageContext.request.contextPath}/comics">
        ...
        <div class="form-group row">
            <label for="publisher" class="col-xs-2 col-form-label">Publisher</label>
            <div class="col-xs-10">
        ...
        <div class="form-group row">
            <label for="price" class="col-xs-2 col-form-label">Shop price</label>
            <div class="col-xs-10">
        ...
        <div class="form-group row">
            <label for="online_url" class="col-xs-2 col-form-label">Comics url</label>
            <div class="col-xs-10">
                <input type="text" class="form-control" id="online_url" name="online_url" placeholder="Enter url">
            </div>
        </div>
        <div class="form-group row">
            <label for="online_price" class="col-xs-2 col-form-label">Price online</label>
            <div class="col-xs-10">
                <input type="number" min="0" step="0.01"
                       class="form-control" id="online_price" name="online_price" placeholder="Enter price online">
            </div>
        </div>
